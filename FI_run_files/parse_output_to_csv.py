...
msg = sys.argv[1]
l1_launch = extract(msg, "Launching L1s took ") #DONE
get_offsets = extract(msg, "Getting offsets from savefile Took ") #create_savefile.sh
create_base =  extract(msg, "Creating base save took ") #DONE
...
wl_tstamp = extract(msg, "Start workload @ ") #DONE
fi_tstamp = extract(msg, "Injecting a fault @ ") #DONE
l0_rdtsc = extract(msg, "Got RDTSC @ ") #DONE
dolma_tsc = extract(msg, "In dolma @ ") #DONE
crash_tstamp = extract(msg, "Crash detected @ ")
base_save_start = extract(msg, "Creating base save file started @ ") #DONE
base_save_end = extract(msg, "Creating base save file ended @ ") #DONE
