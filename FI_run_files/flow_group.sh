...
OFFSET_ADDR=10672562176 # Bernardo
#OFFSET_ADDR=10672578560 # Bernardo, imagens que tinha em casa
...
#HYPERCALLER="/var/lib/nova/instances/git/xen-4.11.1/tools/xcutils/hypercaller2"
HYPERCALLER="/var/lib/nova/instances/gitvmm/xen-4.11.1/tools/xcutils/hypercaller2"
TOTAL_L2_VMS=$4
echo "$TOTAL_L2_VMS - number of L2"
##======
