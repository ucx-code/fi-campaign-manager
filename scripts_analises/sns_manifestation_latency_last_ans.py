...
desired_order = ['HW_A_manifestation.csv', 'HW_B_manifestation.csv', 'SW_A_manifestation.csv', 'SW_B_manifestation.csv', 'CRASH_L1_manifestation.csv', 'CRASH_L2_manifestation.csv', 'HANG_L1_manifestation.csv' ,'HANG_L2_manifestation.csv']
...
plt.ylim(-20, 1000)
y_ticks = range(0, 1050, 50)
plt.yticks(y_ticks, fontsize=16)
plt.xlabel("Dataset",fontsize=14)
plt.ylabel("Manifestation Latency (s)",fontsize=14)


plt.savefig('manifestation_latency_last_ans_sns.pdf', bbox_inches='tight', pad_inches=0)
